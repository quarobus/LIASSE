...
export default function ModalPopUpDocs() {
  ...
  function getUsers() {
    ...
    if (email) {
      axios.get(`http://localhost:8080/api/ProfDocs.php?email=${email}`).then(function(response){
    ...
    <>
      ...
      {modal && (
        <div className="modal-PopUp">
          ...
          <br></br>
          <p><strong>Les doctorants encadrés</strong></p>
              {Array.isArray(users) ? (
                    users.map((user,key) => 
                    <div key={key}>
