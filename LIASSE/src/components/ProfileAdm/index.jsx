        ...
        <div class="container-profil">
            ...
            <div class="B-profil">
                <table class="T-profil ProfileDataTable-profil">
                    ...
                    <td><input type="text" id="nom" name="nom" value="Rachid"/></td>
                    </tr>
                    <tr>
                        <td><label for="prenom">Prénom</label></td>
                        <td><input type="text" id="prenom" name="prenom" value="Rachid"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="specialite" name="specialite" value="Informatique"/></td>
                    </tr>
                    <tr>
                        <td><label for="thematiques">Thématiques de travail</label></td>
                        <td><input type="text" id="thematiques" name="thematiques" value="AI"/></td>
                    </tr>
                    <tr>
