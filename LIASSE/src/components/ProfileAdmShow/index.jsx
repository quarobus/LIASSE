...
function ProfileAdmShow() {
  ...
  function getUsers() {
    ...
    if (email) {
      axios.get(`http://localhost:8080/api/AdmShow.php?email=${email}`).then(function(response){
