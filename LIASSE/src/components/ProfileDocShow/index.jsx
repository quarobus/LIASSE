...
import ModalPopUpDocArticales from '../ModalPopUpDocArticales/ModalPopUpDocArticales';
import ModalPopUpDocProjects from '../ModalPopUpDocProjects/ModalPopUpDocProjects';
import CryptoJS from 'crypto-js';

function ProfileDocShow() {
  ...
  function getUsers() {
    ...
    if (email) {
      axios.get(`http://localhost:8080/api/DocShow.php?email=${encodeURIComponent(email)}`)
      ...
      {Array.isArray(users) && users.length > 0 ? (
         <div key={0} class="container-profil">
            <div class="A-profil">
                ...
                <img class="img-profil" src={users[0].imageProfile} height="120px" width="120px" alt="Profile"/>
